  ...
  document.getElementById('electrons').value = 1;
    ...
    class Particle {
      ...
      draw() {
        ...
        // Efeito de brilho para partículas energéticas
        if (this.energy > 20) {
    ...
    function collideParticles() {
      ...
      // Simular produção de partículas na colisão
    ...
    function animateParticles() {
      ...
      // Atualizar e desenhar partículas do acelerador
      particles = particles.filter(particle => {
        const alive = particle.update();
        if (alive) {
          particle.draw();
          
          // Detetar colisões com o detetor
      ...
      // Atualizar e desenhar partículas de colisão
    ...
    // ====== ATUALIZAÇÕES DO SISTEMA NUCLEAR ======
    function simulateAlphaDecay() {
      ...
      document.getElementById('info').innerHTML += `
        ...
        <p>Partícula alpha (⁴He) emitida com ~5 MeV</p>
      `;
    }
    ...
    function simulateBetaDecay() {
      ...
      document.getElementById('info').innerHTML += `
        ...
        <p>n → p + e⁻ + ν̅ₑ (antineutrino do elétron)</p>
        <p>Elétron de alta energia emitido</p>
      `;
    }

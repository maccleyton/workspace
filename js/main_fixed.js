...
document.querySelector('[data-cmd="openBtn"]').addEventListener('click', () => {
  document.getElementById('mdFileInput').click();
});

// Quando o usuário selecionar um arquivo .md
document.getElementById('mdFileInput').addEventListener('change', function(event) {
  ...
  if (file) {
    ...
    reader.onload = function(e) {
      ...
      document.getElementById('markdownViewer').innerHTML = marked.parse(markdownContent);
    };
